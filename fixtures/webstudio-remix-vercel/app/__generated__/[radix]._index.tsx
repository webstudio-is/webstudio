      ...
      >
        <AccordionItem data-ws-index="0" className="w-item c2onvcp">
          <AccordionHeader className="w-item-header c13v7j50">
            <AccordionTrigger className="w-item-trigger c13v7j50 c1qxdkbn chhejm9 c13bviim cpjvam0 c1tw5o2 cqw88jp c44srea c14kxsax cg783j6 c1ad236a c1s4llbc">
              <Text className="w-text">{"Is it accessible?"}</Text>
              <Box className="w-box c14hansb c6d2sb5 cwwiftc c16vb2zi c1hl6g8z c1xm49r0 c1vri55v">
                <HtmlEmbed
                  code={
