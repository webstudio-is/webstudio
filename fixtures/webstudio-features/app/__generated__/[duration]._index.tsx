...
className={`w-body`}>
<AnimateChildren
action={{"type":"view","animations":[{"name":"Parent","description":"Parallax the element as it scrolls into the view.","keyframes":[{"offset":0,"styles":{"translate":{"type":"tuple","value":[{"type":"unit","unit":"number","value":0},{"type":"unit","unit":"px","value":100}]}}}],"timing":{"easing":"linear","fill":"backwards","duration":{"type":"unit","value":302,"unit":"ms"},"rangeStart":["cover",{"type":"unit","value":0,"unit":"%"}],"rangeEnd":["cover",{"type":"unit","value":50,"unit":"%"}]}}],"insetStart":{"type":"keyword","value":"auto"},"insetEnd":{"type":"keyword","value":"auto"},"isPinned":true,"debug":false}}>
<Heading
