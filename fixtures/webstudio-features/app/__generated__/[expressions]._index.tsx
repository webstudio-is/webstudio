...
import { Heading as Heading, HtmlEmbed as HtmlEmbed, Box as Box } from "@webstudio-is/sdk-components-react/components";
...
let [globalVariable, set$globalVariable] = useVariableState<any>("globalValue")
return <Body
className={`w-body`}>
<Heading
className={`w-heading`}>
