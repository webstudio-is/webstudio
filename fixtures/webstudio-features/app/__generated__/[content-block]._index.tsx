...
import { Box as Box, Heading as Heading, Paragraph as Paragraph } from "@webstudio-is/sdk-components-react/components";
...
className={`w-body`}>
<Box
className={`w-box c620822`}>
<Heading
className={`w-heading cc5h0no`}>
