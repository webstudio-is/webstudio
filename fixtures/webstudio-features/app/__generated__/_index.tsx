...
import { Heading as Heading, Box as Box, Paragraph as Paragraph, Image as Image, Text as Text } from "@webstudio-is/sdk-components-react/components";
      ...
      export const pageBackgroundImageAssets: string[] =
        []
            ...
            export const CustomCode = () => {
              return (<><Script>{"console.log('KittyGuardedZone')"}</Script></>);
            }
...
className={`w-box c1t3ybra c1qxdkbn c1ogzcge cv3kvac`}>
<Image
src={"/assets/_937084ed-a798-49fe-8664-df93a2af605e_uiBk3o6UWdqolyakMvQJ9.jpeg"}
