...
const allBuildNamespaces = [
  ...
  "breakpoints",
  "marketplaceProduct",
] as const satisfies readonly PublicApiOperationNamespace[];
...
export const publicRuntimeOperationContracts = [
  read("build.get", allBuildNamespaces),
  mutation("build.patch", {
    readNamespaces: [],
    writeNamespaces: allBuildNamespaces,
  }),
...
] as const satisfies readonly PublicRuntimeOperationContract[];
