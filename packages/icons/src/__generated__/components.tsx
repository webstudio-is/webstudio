    ...
    return (
      ...
      >
        <path
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M5.535 11.901c-.35.509-.723 1-1.12 1.472C1.577 13.293.5 11.45.5 11.45c.04-2.61.673-5.177 1.85-7.508a6.335 6.335 0 0 1 3.608-1.338l.384.888A12.57 12.57 0 0 1 8 3.373c.557.002 1.113.04 1.665.115l.385-.888a6.335 6.335 0 0 1 3.608 1.35 17.242 17.242 0 0 1 1.842 7.5s-1.077 1.842-3.915 1.923c-.391-.47-.759-.959-1.1-1.465m2.484-1.116C11.492 11.54 10.063 12.29 8 12.29s-3.492-.749-4.97-1.497m3.892-1.946a1.288 1.288 0 1 1-2.577 0 1.288 1.288 0 0 1 2.577 0Zm4.733 0a1.288 1.288 0 1 1-2.577 0 1.288 1.288 0 0 1 2.577 0Z"
        />
      </svg>
    );
  }
