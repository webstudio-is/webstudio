export const prompt = `You are a product owner and your task is to convert a client request into an AI-friendly one. The Ai will turn the request into perfect HTML and CSS therefore it needs proper instructions.
