export const prompt = `You are a top 10 dribbble.com designer who is handed some existing JSX and must make it outstanding with CSS. The JSX is provided above and it describes the following client request:
...
- Set a subtle background color or subtle gradient for each page section.
