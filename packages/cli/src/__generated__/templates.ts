  ...
  defaults: {
    ...
    files: [
      ...
      },
      {
        name: "package.json",
        content:
          '{\n  "private": true,\n  "sideEffects": false,\n  "scripts": {\n    "build": "remix build",\n    "dev": "remix dev",\n    "start": "remix-serve build",\n    "typecheck": "tsc"\n  },\n  "dependencies": {\n    "@remix-run/node": "^1.19.2",\n    "@remix-run/react": "^1.19.2",\n    "@webstudio-is/react-sdk": "^0.98.0",\n    "@webstudio-is/sdk-components-react-radix": "^0.98.0",\n    "@webstudio-is/sdk-components-react-remix": "^0.98.0",\n    "@webstudio-is/sdk-components-react": "^0.98.0",\n    "@webstudio-is/form-handlers": "^0.98.0",\n    "@webstudio-is/image": "^0.98.0",\n    "@webstudio-is/sdk": "^0.98.0",\n    "isbot": "^3.6.8",\n    "react": "^18.2.0",\n    "react-dom": "^18.2.0"\n  },\n  "devDependencies": {\n    "@remix-run/serve": "^1.19.2",\n    "@remix-run/dev": "^1.19.2",\n    "@types/react": "^18.2.20",\n    "@types/react-dom": "^18.2.7",\n    "@webstudio-is/http-client": "^0.98.0",\n    "eslint": "^8.48.0",\n    "typescript": "5.2.2"\n  },\n  "engines": {\n    "node": ">=18.0.0"\n  }\n}\n',
        encoding: "utf-8",
        merge: true,
      },
      {
