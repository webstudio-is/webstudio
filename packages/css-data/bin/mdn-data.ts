...
writeToFile("properties.ts", "properties", getPropertiesData());
writeToFile("keyword-values.ts", "keywordValues", getKeywordValues());
writeToFile(
...
writeFileSync(typesFile, autogeneratedHint + getTypes(getPropertiesData()));
