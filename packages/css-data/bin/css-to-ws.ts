...
export const _styles = ${JSON.stringify(records, null, 2)};
type WIcons = Record<
  \`w-icon-\${string}\`,
  (typeof _styles)[\`w-icon-slider-right\`]
>;
export type Styles = typeof _styles & WIcons;
export const styles: Styles = _styles;
`;
