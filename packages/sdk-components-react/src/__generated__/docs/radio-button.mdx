---
title: "Radio"
description: "Radio Webstudio component."
component: true
base: "webstudio"
sourcePackage: "@webstudio-is/sdk-components-react"
sourceExport: "RadioButton"
---

# Radio

Radio Webstudio component.

## Installation

Use the Webstudio component registry item `radio-button`.
...
- `value`: type: `string`, control: `text`. Value of the form control
