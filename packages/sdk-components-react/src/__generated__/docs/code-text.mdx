---
title: "Code text"
description: "Code text Webstudio component."
component: true
base: "webstudio"
sourcePackage: "@webstudio-is/sdk-components-react"
sourceExport: "CodeText"
---

# Code text

Code text Webstudio component.

## Installation

Use the Webstudio component registry item `code-text`.
...
- `code` required: type: `string`, control: `codetext`.
