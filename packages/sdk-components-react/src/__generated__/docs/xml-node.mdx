...
Use the Webstudio component registry item `xml-node`.
...
- `href`: type: `string`, control: `text`. Address of the hyperlink
- `hreflang`: type: `string`, control: `text`. Language of the linked resource
- `rel`: type: `string`, control: `text`. Relationship between the location in the document containing the hyperlink and the destination resource
- `tag`: type: `string`, control: `text`, default: `""`.
- `xmlns`: type: `string`, control: `text`.
- `xmlns:xhtml`: type: `string`, control: `text`.
