---
title: "List"
description: "List Webstudio component."
component: true
base: "webstudio"
...
List Webstudio component.

## Installation

Use the Webstudio component registry item `list`.
...
- `ordered`: type: `boolean`, control: `boolean`, default: `false`. Shows numbers instead of bullets when toggled. See the “List Style Type” property under the “List Item” section in the Style panel for more options.
