...
sourceExport: "XmlTime"
---

# Xml time

Converts machine-readable date and time to ISO format.

## Installation

Use the Webstudio component registry item `xml-time`.
...
- `dateStyle`: type: `string`, control: `radio`, default: `"short"`.
- `datetime`: type: `string`, control: `text`, default: `"dateTime attribute is not set"`. Machine-readable value
