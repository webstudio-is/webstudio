...
const toFragment = (
  ...
  const addProp = (
    ...
    const prop = { id: createId(), instanceId };
...
export const addInstanceAndProperties = (
  ...
  const nextFragment = toFragment(wfNode, instanceId, createId);
  ...
  addCustomAttributes(wfNode, instanceId, fragment.props, createId);
