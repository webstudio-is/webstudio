...
export const colorTokenSource = {
  ...
  semantic: {
    ...
    backgroundNeutralSubtle: ["mix", "theme.canvas", 97, "theme.ink"],
    backgroundNeutral: ["mix", "theme.canvas", 92, "theme.ink"],
    backgroundNeutralHover: ["mix", "theme.canvas", 88, "theme.ink"],
    backgroundNeutralPressed: ["mix", "theme.canvas", 82, "theme.ink"],
    backgroundNeutralDisabled: ["mix", "theme.canvas", 96, "theme.ink"],
    backgroundNeutralStrong: ["mix", "theme.canvas", 68, "theme.ink"],
    ...
    contentPrimary: "theme.ink",
    contentSecondary: ["mix", "theme.ink", 68, "theme.canvas"],
    contentMuted: ["mix", "theme.ink", 52, "theme.canvas"],
    contentDisabled: ["mix", "theme.ink", 34, "theme.canvas"],
    contentInverse: "theme.canvas",
    contentInverseSecondary: ["mix", "theme.canvas", 72, "theme.ink"],
    contentAccent: ["mix", "theme.accent", 86, "theme.ink"],
    contentPositive: ["mix", "theme.positive", 86, "theme.ink"],
    contentNegative: ["mix", "theme.negative", 86, "theme.ink"],
    contentWarning: ["mix", "theme.warning", 86, "theme.ink"],
    contentInformative: ["mix", "theme.informative", 86, "theme.ink"],
  ...
  compatibility: {
    ...
    backgroundStyleSourceGradientUnselected: [
      ...
      [
        ...
        {
          color: "semantic.contentSecondary",
          position: 31.87,
        },
      ],
    ],
    ...
    brandBackgroundProjectCardFront: [
      ...
      [
        {
          color: "semantic.backgroundCanvas",
        },
        {
          color: "semantic.backgroundNeutral",
        },
      ],
    ],
    brandBackgroundProjectCardBack: [
      ...
      [
        ...
        {
          color: "semantic.backgroundNeutralStrong",
        },
      ],
    ],
