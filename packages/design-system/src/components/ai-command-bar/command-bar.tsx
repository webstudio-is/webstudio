...
export const CommandBarContentPrompt = forwardRef<
  HTMLButtonElement,
  {
    children: ReactNode;
    onClick?: () => void;
...
>((props, ref) => {
  return (
    <CommandBarContentPromptStyled ref={ref} color="dark" {...props}>
...
CommandBarContentPrompt.displayName = "CommandBarContentPrompt";
