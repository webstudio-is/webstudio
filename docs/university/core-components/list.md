...
<figure><img src="../../.gitbook/assets/list-component-properties.avif" alt="List settings showing ordered and unordered list properties"><figcaption></figcaption></figure>
