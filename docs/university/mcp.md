...
| `issues` | All content errors and warnings found for the query. Each diagnostic identifies its query or published-database scope, phase, code, message, asset, path, and source location when available. |
