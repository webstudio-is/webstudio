 ...
 * Includes pathname, search params, and full URL details.
 *
 * Note: Hash fragments are not included as they are client-side only
 * and never sent to the server, which would cause hydration mismatches.
 */
