const svgSpinner = `
<svg id="e2CRglijn891" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
     viewBox="0 0 128 128" shape-rendering="geometricPrecision" text-rendering="geometricPrecision">
    <style>
        <![CDATA[
          #e2CRglijn892_tr {
            animation: e2CRglijn892_tr__tr 4000ms linear infinite normal forwards
          }
    ...
    <g id="e2CRglijn892_tr" transform="translate(64,64) rotate(90)">
        <ellipse id="e2CRglijn892" rx="42" ry="42" transform="scale(-1,1) translate(0,0)" fill="none" stroke="#39fbbb"
                 stroke-width="16" stroke-linecap="round" stroke-dashoffset="251.89" stroke-dasharray="263.89"/>
    </g>
</svg>
`;
